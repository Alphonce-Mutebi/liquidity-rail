...
import type { Action, FeeCost, LiFiStep, SignedLiFiStep, StepToolDetails } from './step.js';
...
export declare const ExecutionTypes: readonly ["transaction", "message", "all"];
...
export declare const TokensSortOrders: readonly ["marketCapUSD", "priceUSD", "volumeUSD24H", "fdvUSD"];
...
export type TypedDataPrimaryType = 'Permit' | 'PermitTransferFrom' | 'PermitBatchTransferFrom' | 'PermitWitnessTransferFrom' | 'PermitBatchWitnessTransferFrom' | 'Order' | 'HyperliquidTransaction:Withdraw' | 'HyperliquidTransaction:UsdSend' | 'HyperliquidTransaction:SpotSend' | 'HyperliquidTransaction:SendAsset';
/**
 * EIP-712 Typed Data
